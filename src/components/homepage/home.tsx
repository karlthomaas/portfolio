...
export const HomeSection = () => {
  return (
    <div className=''>
      <HomeLayoutWrapper id='home' tag='section' className='bg-lines'>
        <div className='h-[calc(100vh-16px)] text-foreground'>
          <div className='flex h-max w-full flex-col items-center pt-[100px] sm:flex-row sm:justify-between sm:pt-[200px]'>
